...
export default function LightGallery({ images }) {
  ...
  return (
    <div className='mt-10 grid gap-4'>
      <div className='container mx-auto grid gap-4 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4'>
      ...
      {isOpen && (
        <div className='absolute top-0 left-0 z-50 w-full h-full bg-black bg-opacity-90 grid place-content-center'>
