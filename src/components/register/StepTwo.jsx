  ...
  return (
    <>
      ...
      <div className='grid md:grid-cols-2 gap-6 mt-5'>
        <div>
          ...
          <select
            ...
            className='mt-2 w-full rounded-lg bg-transparent border border-gray-200 p-4 pe-12 text-sm text-wblack *:text-black'
          >
            <option value=''>{translates.select_option}</option>
        ...
        <div>
          ...
          <select
            ...
            defaultValue={area}
            className='mt-2 w-full rounded-lg bg-transparent border border-gray-200 p-4 pe-12 text-sm text-wblack *:text-black uppercase'
          >
            <option value=''>{translates.select_option}</option>
          ...
          <div className='relative mt-2'>
            {country === 'Mexico' ? (
              <select
                ...
                className='mt-2 w-full rounded-lg bg-transparent border border-gray-200 p-4 pe-12 text-sm text-whiblack *:text-black'
              >
                <option value=''>{translates.select_option}</option>
                {colonias.length > 0 &&
      ...
      <div className='flex justify-between'>
        <button
          className='px-3 py-2 bg-black hover:bg-[#0063d9] rounded-2xl text-white font-bold mt-5 flex gap-2'
