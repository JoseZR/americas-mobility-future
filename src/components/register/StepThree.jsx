  ...
  return (
    <>
      ...
      <div className='grid mt-5'>
        <p className='font-semibold text-black'>{translates.already_visited}</p>
        <MultiSelect
          options={options}
      ...
      <div className='flex justify-between'>
        <button
          className='px-3 py-2 bg-black hover:bg-[#0063d9] rounded-2xl font-bold text-white  mt-5 flex gap-2'
        ...
        <button
          className='px-3 py-2 bg-black hover:bg-[#0063d9] font-bold rounded-2xl text-white  mt-5 flex gap-2'
